					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								...
								<li class="menu-item">
									<a href="about-us.html" class="link-term mercado-item-title">Про сайт</a>
								</li>
								<li class="menu-item">
									<a href="/shop" class="link-term mercado-item-title">Каталог</a>
								</li>
								<li class="menu-item">
									<a href="/cart" class="link-term mercado-item-title">Кошик</a>
								</li>
								<li class="menu-item">
									<a href="/checkout" class="link-term mercado-item-title">Замовлення</a>
								</li>
								<li class="menu-item">
