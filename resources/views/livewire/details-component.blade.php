					...
					<div class="wrap-product-detail">
						...
						<div class="detail-info">
                            ...
                            <div class="wrap-price">
                                <span class="product-price">{{$product->regular_price}} грн</span>
                            </div>
							...
							<div class="wrap-butons">
								<a href="#" class="btn add-to-cart">До кошика</a>
                                <div class="wrap-btn">
                                    <a href="#" class="btn btn-compare">Порівняння</a>
                                    <a href="#" class="btn btn-wishlist">Обране</a>
                                </div>
							</div>
						</div>
						<div class="advance-info">
							<div class="tab-control normal">
								<a href="#description" class="tab-control-item active">Опис</a>
								<a href="#add_infomation" class="tab-control-item">Інформація</a>
								<a href="#review" class="tab-control-item">Огляд</a>
							</div>
