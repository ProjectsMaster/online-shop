                    ...
                    <div class="register-form form-item ">
                        ...
                        <form class="form-stl" action="{{route('register')}}" name="frm-login" 
                            ...
                            <fieldset class="wrap-title">
                                <h3 class="form-title">Реєстрація користувача</h3>
                                <h4 class="form-subtitle">Персональна інформація</h4>
                            </fieldset>									
                            <fieldset class="wrap-input">
                                <label for="frm-reg-lname">Name*</label>
                                <input type="text" id="frm-reg-lname" name="name" placeholder="Last name*"
                                    required autofocus autocomplete="name" :value="name">
                            </fieldset>
                            <fieldset class="wrap-input">
                            ...
                            <fieldset class="wrap-title">
                                <h3 class="form-title">Реєстраційні дані</h3>
                            </fieldset>
